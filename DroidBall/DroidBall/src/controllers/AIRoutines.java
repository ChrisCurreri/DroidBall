...
public class AIRoutines {
	 ...
	 */
	public static LinkedList<GridNode> CalculateAStar(Droid start, Droid finish, Grid2d gameGrid) {
		...
		PriorityQueue<GridNode> open = new PriorityQueue<GridNode>(11, new Comparator<GridNode>() {
		...
		while(!open.isEmpty()) {
			...
			if(current.equals(finish)) {
				LinkedList<GridNode> route = new LinkedList<GridNode>();
				while(current != start) {
